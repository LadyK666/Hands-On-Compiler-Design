...
static const char *const yytname[] =
{
  ...
  "MINUS", "TIMES", "DIVIDE", "LPAREN", "RPAREN", "$accept", "input",
...
#line 29 "parser.y"
        ...
        printf("\n=== 表达式结果 ===\n");
        int result = evaluate((yyvsp[0].node));
        printf("结果: %d\n", result);
...
#line 40 "parser.y"
                   {
        (yyval.node) = create_op_node(NODE_PLUS, (yyvsp[-2].node), (yyvsp[0].node));
    }
...
#line 43 "parser.y"
                      {
        (yyval.node) = create_op_node(NODE_MINUS, (yyvsp[-2].node), (yyvsp[0].node));
    }
...
#line 52 "parser.y"
                      {
        (yyval.node) = create_op_node(NODE_TIMES, (yyvsp[-2].node), (yyvsp[0].node));
    }
...
#line 55 "parser.y"
                         {
        (yyval.node) = create_op_node(NODE_DIVIDE, (yyvsp[-2].node), (yyvsp[0].node));
    }
...
#line 64 "parser.y"
          {
        (yyval.node) = create_digit_node(atoi(yytext));
    }
